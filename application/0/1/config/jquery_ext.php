...
$config['jquery_ext']['main_library_path']		= "http://woon.prj/frame/frame/asset/js/jquery.min.js";		// without the first slash if is a local path.
...
$config['jquery_ext']['functions'] = array(
										"general"		 => "%s",
										"document_ready" => "$('document').ready(function (){ %s });"
