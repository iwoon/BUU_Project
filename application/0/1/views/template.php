...
<title><?php echo $this->template->title->default("ระบบจัดการผู้ใช้"); ?></title>
<link href="<? echo base_url().'./asset/css/template.css';?>" rel="stylesheet" type="text/css" />
...
<body>
	<div id="header">
      <div class="logo"><img src="<? echo base_url().'./asset/images/buu_logo.jpg';?>" alt="มหาวิทยาลัยบูรพา" width="100px" height="100px" /></div><p class="apptitle"> ระบบจัดการผู้ใช้</p>
