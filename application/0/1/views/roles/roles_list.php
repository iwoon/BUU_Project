...
<tbody>
    ...
    <tr <?echo ($i%2)? 'class="odd"':'';?>>
        ...
        <td><? echo anchor('roles/roles_main/#'.$role->role_id,'เพิ่มบทบาทย่อย',array('class'=>'add_subroles'));?>,<? echo anchor('permissions/permissions_roles/'.$role->role_id,'สิทธิ',array('class'=>'manage_p'));?>,<? echo anchor('roles/roles_main/members/'.$role->role_id,'สมาชิก',array('class'=>'assign_users'));?></td>
    </tr>
<?
    endforeach;
?></tbody>
